# AptToSell Educational & Research Resource

AptToSell provides reusable housing-subscription reference data for education, research, journalism, and public-information content.
...
- 민영주택 예치금 CSV  
  https://raw.githubusercontent.com/cheer710815-hub/apttosell-subscription-data/main/private_housing_deposit_2026.csv

## Suggested educational uses

- 청약가점 계산 실습
- 무주택기간·부양가족·청약통장 배점 구조 교육
- 민영주택 지역·면적별 예치금 비교
- 공식 법령과 가공 데이터의 차이 비교
- CSV 기반 부동산·주택청약 데이터 분석

## For outdated or discontinued resource links

기관·대학의 관련사이트 목록에서 오래되었거나 운영이 중단된 청약·분양 정보 링크를 정리할 때 다음 공개 자료를 대체 참고자료로 검토할 수 있습니다.
